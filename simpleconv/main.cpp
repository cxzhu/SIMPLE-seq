...
void combine2_help(){
	cout << "simpleconv combine2 sample_Prefix gz/bz2(default gz)" << endl;
}

// processing SIMPLE-seq with 2-round ligation, brain dataset specific barcodes, expanded R02 and R03 to 8bp
...
void combine3_help(){
	cout << "simpleconv combine3 sample_Prefix gz/bz2(default gz)" << endl;
}
